package com.rcdomingos.course.config;
...
import com.rcdomingos.course.entities.Payment;
import com.rcdomingos.course.entities.Product;
import com.rcdomingos.course.entities.User;
import com.rcdomingos.course.entities.enums.OrderStatus;
import com.rcdomingos.course.repositories.CategoryRepository;
import com.rcdomingos.course.repositories.OrderItemRepository;
...
//arquivo de configuração do perfil teste
@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner {

	@Autowired // injeção de dependica do spring
